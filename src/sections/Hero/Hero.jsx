  ...
  return (
    <section className="px-4 py-12 w-full flex flex-col items-center justify-center gap-y-8 bg-white">
      <SplitText
        ...
        className="md:text-5xl text-xl text-center font-heading font-extrabold text-primary"
        delay={20}
        duration={0.6}
        ease="power3.out"
        splitType="chars"
      ...
      <SplitText
        ...
        className="text-2xl sm:text-3xl md:text-5xl text-center font-heading font-extrabold text-secondary max-w-6xl"
        delay={20}
        duration={0.6}
        ease="power3.out"
        splitType="chars"
      ...
      <div className="w-full bg-primary text-white py-4 px-6 flex items-center justify-center shadow-lg rounded-lg mt-8">
        <a
