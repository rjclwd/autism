...
const AppointmentFloat = () => {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 bg-secondary hover:bg-accent flex items-center gap-x-2 z-30 text-white font-semibold px-6 py-3 rounded-full shadow-lg"
      animate={{
