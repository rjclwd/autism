...
const products = [
  ...
  },
  {
    ...
    price: "180",
    image: "/rl-13-for-gastritis-acidity-all-types-stomach-problem-drops.jpg",
    badge: "Digestive Care",
  ...
  },
  {
    ...
    price: "390",
    image: "/rl-36-gastritis-acidity-all-types-stomach-problems-syrup.jpg",
    badge: "Digestive Care",
...
const diseaseData = [
  {
    ...
    description:
      "A condition where stomach acid flows back into the esophagus, causing heartburn and discomfort.",
    symptoms: [
      "Heartburn",
      "Regurgitation",
      "Bitter taste",
  ...
  },
  {
    ...
    description:
      "A common disorder affecting the large intestine, causing cramping, abdominal pain, bloating, and changes in bowel habits.",
  ...
  },
  {
    ...
    name: "Constipation",
    description:
      "Difficulty in passing stools, often due to diet, lifestyle, or digestive conditions.",
    symptoms: [
  ...
  },
  {
    ...
    name: "Diarrhea",
    description:
      "Frequent loose or watery bowel movements caused by infections, food intolerance, or digestive disorders.",
    symptoms: [
      "Loose stools",
      "Abdominal cramps",
      "Dehydration",
  ...
  },
  {
    ...
    name: "Gas & Bloating",
    description:
      "Excess gas in the digestive tract leading to discomfort, fullness, and abdominal distension.",
    symptoms: ["Abdominal fullness", "Flatulence", "Burping", "Abdominal pain"],
  },
  {
    id: "peptic_ulcer",
    name: "Peptic Ulcer",
    description:
      "Sores that develop on the lining of the stomach, small intestine, or esophagus due to excess acid or infection.",
    symptoms: [
      "Abdominal pain",
      "Heartburn",
      "Nausea",
  ...
  },
  {
    ...
    name: "Gallstones",
    description:
      "Hardened deposits in the gallbladder that can block bile flow, causing pain and digestive issues.",
  ...
  },
  {
    ...
    name: "Liver Disease",
    description:
      "Disorders affecting liver function, including fatty liver, hepatitis, and cirrhosis.",
  ...
  },
  {
    ...
    name: "Pancreatitis",
    description:
      "Inflammation of the pancreas causing severe abdominal pain and digestive disturbances.",
    symptoms: ["Severe upper abdominal pain", "Nausea", "Vomiting", "Fever"],
  },
  {
    id: "celiac_disease",
    name: "Celiac Disease",
    description:
      "An autoimmune disorder triggered by gluten ingestion, damaging the small intestine lining.",
    symptoms: [
      "Diarrhea",
      "Bloating",
      "Fatigue",
